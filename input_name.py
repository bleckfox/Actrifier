...
'''
пофиксить строку поиска на главной
сделать поиск из страницы карточки
показать роль в фильме
сделать поиск feeling lucky
вынести функции парсинга в отдельный файл (который и будет API)
